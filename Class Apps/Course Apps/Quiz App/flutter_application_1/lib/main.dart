...
class _QuizAppState extends State{
  List<Map> allQuestions= [
    ...
    {
      "question":"Who is the founder Google?",
      "options":["Steve Jobs","Bill Gates","Lary Page","Elon Musk"],
      "correctAnswer":2
    },
    {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: (){
            if(selectedAnswerIndex != -1){
              ...
              ///THIS CHECK THE CONDITION AND THE RESULT SCREEN
    ...
    return Scaffold(
      ...
      body:Center(
        child:Column(
          ...
          children: [
            Image.network("https://tse4.mm.bing.net/th?id=OIP.z0xip-AXnul370e7WWcoaQHaNT&pid=Api&P=0&h=180",
            height: 300,
            ),
